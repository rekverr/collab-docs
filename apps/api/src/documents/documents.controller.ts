...
export class DocumentsController {
  ...
  create(
    ...
    return this.documents.create(user.id, workspaceId, input);
  }
  ...
  update(
    ...
    return this.documents.update(user.id, documentId, input);
  }
  ...
  move(
    ...
    return this.documents.move(user.id, documentId, input);
  }
  ...
  reorder(
    ...
    return this.documents.reorder(user.id, workspaceId, input);
  }
